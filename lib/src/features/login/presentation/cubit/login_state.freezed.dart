...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(User user, String role) loggedIn,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(User user, String role)? loggedIn,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$LoggedInImpl implements LoggedIn {
  const _$LoggedInImpl(this.user, this.role);
  ...
  @override
  String toString() {
    return 'LoginState.loggedIn(user: $user, role: $role)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loggedIn?.call(user, role);
  }
...
abstract class LoggedIn implements LoginState {
  const factory LoggedIn(final User user, final String role) = _$LoggedInImpl;
